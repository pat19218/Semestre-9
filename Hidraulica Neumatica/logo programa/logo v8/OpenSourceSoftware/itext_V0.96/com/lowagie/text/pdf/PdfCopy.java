/*
 * $Id: PdfCopy.java,v 1.1 2002/11/19 08:33:36 blowagie Exp $
 * $Name:  $
 *
...
public class PdfCopy extends PdfWriter {
    ...
    protected PdfIndirectReference copyIndirect(PRIndirectReference in) throws IOException, BadPdfFormatException {
        ...
        iRef.setCopied();
        PdfObject obj = copyObject((PdfObject)reader.getPdfObject(in));
    ...
    public void copyAcroForm(PdfReader reader) throws IOException, BadPdfFormatException {
        ...
        if (! iRef.getCopied()) {
            iRef.setCopied();
            PdfDictionary theForm = copyDictionary((PdfDictionary)reader.getPdfObject(hisRef));
