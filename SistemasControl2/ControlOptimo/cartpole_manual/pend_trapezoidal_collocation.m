...
N = 39; % número de segmentos
M = N + 1; % número de puntos de colocación
n = 4; % número de variables de estado
m = 1; % número de entradas
d = 1; % posición final del carro del péndulo
dmax = 2; % límites del riel del carro (se asume un riel simétrico)
umax = 20; % límites de la fuerza/motor que actúa el carro
x0 = [0; 0; 0; 0]; % condición inicial
xN = [d; pi; 0; 0]; % condición final
